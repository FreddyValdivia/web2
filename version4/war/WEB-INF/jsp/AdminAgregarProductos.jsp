...
<body>
	...
	<form action="saveProducto" method="get">
		<fieldset><legend>Registro de Productos</legend>
		<div id="formulario">
			<div class="fila">
				<div class="etiqueta"><label for="name">Nombre del Producto :</label></div>
				<div class="control"><input type="text" name="name" maxlength="20" required=""/></div>
			</div>
			<div class="fila">
				<div class="etiqueta"><label for="costo">Costo :</label></div>
				<div class="control"><input type="text" name="costo" maxlength="9" pattern="[0-9]{1,3}" title="Solo numeros de 1 a 3 digitos" required=""/></div>
			</div>
			<div class="fila">
