...
public class LoginAdmin extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		if(usuario.equals("admin")&& password.equals("12345678"))
		{
			...
			{
				case 0:
					RequestDispatcher rd1 = getServletContext().getRequestDispatcher("/WEB-INF/jsp/noExisteAdmin.jsp");
					rd1.forward(req, resp);
					break;
				case 1:
					RequestDispatcher rd2 = getServletContext().getRequestDispatcher("/WEB-INF/jsp/noExisteAdmin.jsp");
