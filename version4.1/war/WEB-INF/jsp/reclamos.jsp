...
<br><br><br><br>
<form method='post' action="saveReclamo">
<fieldset><legend>Reclamos</legend>
<div id="formulario">
	<div class="fila">
	...
	<div class="fila">
		<div class="etiqueta"><label for="reclamo">Reclamo :</label></div> 
 		<div class="control"><textarea name="reclamo" id="reclamo" required="" rows="4" cols="50" ></textarea></div>
	</div>
	<br>
	<div class="fila">
