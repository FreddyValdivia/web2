...
public class VerCursosInscritos extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if( req.getParameter("nombC")!=null ){

			String nombreC = req.getParameter("nombC");
			...
			try{
				...
				RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/jsp/verCursosInscritos.jsp");
				rd.forward(req, resp);
